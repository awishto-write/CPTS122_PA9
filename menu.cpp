...
Menu::Menu(float width, float height)
{
	...
	mainMenu[1].setFillColor(sf::Color::Cyan);  // was white before
	...
	mainMenu[2].setFillColor(sf::Color::Cyan);  // was white before
...
void Menu::moveDown()
{
	...
	{
		mainMenu[mainMenuSelected].setFillColor(sf::Color::Cyan);  // starting color
		...
		mainMenu[mainMenuSelected].setFillColor(sf::Color::Blue);   // element has been picked
	}
}
